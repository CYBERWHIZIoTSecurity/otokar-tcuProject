...
#define E_NW_MONITOR_SEM_INIT           (E_LIB_GSM_NOS + 13)
...
#define E_CAN3_WAKEUP_FILE_CLOSE_ERROR	(E_LIB_CAN_NOS + 13)
#define E_CAN4_WAKEUP_FILE_CLOSE_ERROR	(E_LIB_CAN_NOS + 14)
...
#define E_OBD2_LIB_BLE_INIT_ERROR       (E_LIB_BLE_NOS + 3)
